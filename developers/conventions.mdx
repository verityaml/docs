...
<Warning>
Never hardcode pillar labels, pillar order, obligation types, or regulation type lists in components or API routes. Always import from `@verity/backend/config`.
</Warning>
