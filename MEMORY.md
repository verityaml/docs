...
No new merged PRs since previous checkpoint (#513). Verity `main` has not moved — HEAD is still `d3bf25ea`. PRs #514, #515, #516 were closed (not merged) Dependabot dependency bumps.
