...
No new merged PRs since previous checkpoint (#510). Verity `main` has not moved — HEAD is still `d3bf25ea`. Three Dependabot PRs (#514, #515, #516) were closed without merging.
