...
No new merged PRs since previous checkpoint (#513). Verity `main` has not moved — HEAD is still `d3bf25ea`. PRs #514–#520 are unmerged Dependabot dependency bumps (all closed without merge).
