...
No new merged PRs since previous checkpoint (#513). Verity `main` has not moved — HEAD is still `d3bf25ea`. Recent closed PRs (#514–#520) are all Dependabot dependency bumps closed without merging.
