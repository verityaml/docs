...
No new merged PRs since previous checkpoint (#513). Verity `main` has not moved — HEAD is still `d3bf25ea`. PRs #514–520 (all Dependabot npm_and_yarn bumps) were closed without merging.
