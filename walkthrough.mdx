...
**Where to find it:** The **Find Evidence** button in the domain detail page header.

This is the bridge between your examination workflow and your compliance program scoring.

When you click "Find Evidence," a dialog appears listing your organization's examinations. Select one, and the system scans that examination's request items and their attached evidence against the criteria in the current domain.
...
2. **Domain/pillar alignment** — if a request item's assigned pillar corresponds to the current domain, the evidence is likely relevant
